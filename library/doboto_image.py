...
class Image(DOBOTOModule):
    ...
    def input(self):
        ...
        return AnsibleModule(
            ...
            required_if=[
                ["action", "info", ["id", "slug"], True],
                ["action", "update", ["id", "name"]],
                ["action", "destroy", ["id"]],
                ["action", "convert", ["id"]],
                ["action", "transfer", ["id", "region"]],
    ...
    def transfer(self):
        ...
        self.module.exit_json(
            changed=True,
            action=self.do.image.transfer(
                self.module.params["id"],
                self.module.params["region"],
                wait=self.module.params["wait"],
                poll=self.module.params["poll"],
                timeout=self.module.params["timeout"]
            )
    ...
    def action_list(self):
        ...
        self.module.exit_json(
            changed=False,
            actions=self.do.image.action_list(
                self.module.params["id"]
            )
        )
    ...
    def action_info(self):
        ...
        self.module.exit_json(
            changed=False,
            action=self.do.image.action_info(
                self.module.params["id"],
